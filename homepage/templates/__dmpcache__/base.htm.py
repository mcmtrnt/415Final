...
_magic_number = 10
_modified_time = 1555512218.8159394
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        if request.user.has_perm('homepage.view_ad'):
            __M_writer('                        <li class="nav-item active">\r\n                            <a class="btn btn-outline-primary" href="/homepage/calculator/">Price my bike<span class="sr-only">(current)</span></a>\r\n                        </li>\r\n\r\n                        <li class="nav-item active">\r\n                            <a class="btn btn-outline-primary" href="/homepage/visualizations/">Story<span class="sr-only">(current)</span></a>\r\n                        </li>\r\n\r\n                        <li class="nav-item active">\r\n                            <a class="btn btn-outline-primary" href="/homepage/dashboard/">Dashboard<span class="sr-only">(current)</span></a>\r\n                        </li>\r\n')
        else:
...
"""
__M_BEGIN_METADATA
{"filename": "C:/Users/Trent/scraper/homepage/templates/base.htm", "uri": "base.htm", "source_encoding": "utf-8", "line_map": {"18": 0, "27": 2, "28": 11, "29": 21, "30": 22, "31": 22, "32": 33, "33": 34, "34": 38, "35": 39, "36": 40, "37": 51, "38": 52, "39": 56, "40": 58, "41": 59, "42": 62, "43": 63, "44": 67, "49": 77, "55": 75, "61": 75, "67": 61}}
__M_END_METADATA
"""
